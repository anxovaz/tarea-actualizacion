...
Una vez listo el repositorio en github con los archivos del ejercicio de `hundir la flota` y clonado localmente, accedo al repositorio de github y modifico el archivo `tablero.py`
